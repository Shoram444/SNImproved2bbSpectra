...
# ╔═╡ 4013a6c3-8846-474a-82d2-8a3fa1dfa328
pwd()
...
saveFileName = "FromRasto_xi31=0.3738_K=-0.6638.dat";
...
2. (If needed) Parse strings to Floats: `df_raw.E1 = parse.(Float64, df_raw.E1)`
3. Rebin the spectrum: `df = rebin2D(df_raw, 0.001)`
4. Normalize: `df = normalize2D!(df)`
5. Generate CDF column (for sampling): `df = get_cdf!(df)`
...
# ╔═╡ 9c8ef9a4-3ae0-4818-9be0-5fc351808cf3
dfMe = CSV.File(joinpath(dataDir, "rebinned", "xi51_0.1397-xi31_0.3738-K2v_-0.6638-G0_G2_G22_G4.csv")) |> DataFrame

# ╔═╡ c2a5f14a-4a01-43f9-9220-4e44be3db44a
dfRD = CSV.File(joinpath(dataDir, "rebinned", "FromRasto_xi31=0.3738_K=-0.6638.csv")) |> DataFrame

# ╔═╡ 19c3f10e-cfc4-4c2c-b9de-043a835c38af
...
MPRebinSpectra = "594ef75b-651d-4ccd-8a30-194b17b3160e"
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "55da0668c3c4789c9c17b6cc809176ac90683b0a"
...
[[deps.MPRebinSpectra]]
deps = ["ColorSchemes", "DataFrames", "DataFramesMeta", "Distributions", "Random", "StatsPlots"]
git-tree-sha1 = "bca3cd15cd403c9574510745f3e2294693f458db"
repo-rev = "main"
repo-url = "https://github.com/Shoram444/MPRebinSpectra.jl.git"
uuid = "594ef75b-651d-4ccd-8a30-194b17b3160e"
version = "0.1.0"
